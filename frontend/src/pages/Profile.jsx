        ...
        isEditing ? (
          ...
          <>
            ...
            <div className="mb-2">
              ...
              {user.jobSeekerProfile.resume_url ? (
                <a
                  href={`http://localhost:3000${user.jobSeekerProfile.resume_url}`}
              ...
              onSubmit={async (e) => {
                ...
                try {
                  const res = await axios.post(
                    'http://localhost:3000/api/job-seekers/upload-resume',
                    formData,
                    {
                      headers: {
